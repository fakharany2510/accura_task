...
class laboratoryAndRayCenterSetting extends StatefulWidget {
  const laboratoryAndRayCenterSetting({Key? key}) : super(key: key);

  @override
  State<laboratoryAndRayCenterSetting> createState() =>
      _laboratoryAndRayCenterSettingState();
}

class _laboratoryAndRayCenterSettingState
    extends State<laboratoryAndRayCenterSetting> {
